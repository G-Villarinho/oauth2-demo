...
func (_m *UserRepositoryMock) Create(ctx context.Context, user *models.User) error {
...
func (_c *UserRepositoryMock_Create_Call) Run(run func(ctx context.Context, user *models.User)) *UserRepositoryMock_Create_Call {
...
func (_c *UserRepositoryMock_Create_Call) RunAndReturn(run func(context.Context, *models.User) error) *UserRepositoryMock_Create_Call {
	_c.Call.Return(run)
	return _c
}

// FindByEmail provides a mock function with given fields: ctx, email
func (_m *UserRepositoryMock) FindByEmail(ctx context.Context, email string) (*models.User, error) {
...
func (_c *UserRepositoryMock_FindByEmail_Call) Return(_a0 *models.User, _a1 error) *UserRepositoryMock_FindByEmail_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserRepositoryMock_FindByEmail_Call) RunAndReturn(run func(context.Context, string) (*models.User, error)) *UserRepositoryMock_FindByEmail_Call {
	_c.Call.Return(run)
	return _c
}

// FindByID provides a mock function with given fields: ctx, id
func (_m *UserRepositoryMock) FindByID(ctx context.Context, id string) (*models.User, error) {
...
func (_c *UserRepositoryMock_FindByID_Call) Return(_a0 *models.User, _a1 error) *UserRepositoryMock_FindByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserRepositoryMock_FindByID_Call) RunAndReturn(run func(context.Context, string) (*models.User, error)) *UserRepositoryMock_FindByID_Call {
	_c.Call.Return(run)
	return _c
}
