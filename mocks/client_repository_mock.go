...
func (_m *ClientRepositoryMock) Create(ctx context.Context, client *models.Client) error {
...
func (_c *ClientRepositoryMock_Create_Call) Run(run func(ctx context.Context, client *models.Client)) *ClientRepositoryMock_Create_Call {
...
func (_c *ClientRepositoryMock_Create_Call) RunAndReturn(run func(context.Context, *models.Client) error) *ClientRepositoryMock_Create_Call {
	_c.Call.Return(run)
	return _c
}

// GetByClientID provides a mock function with given fields: ctx, clientID
func (_m *ClientRepositoryMock) GetByClientID(ctx context.Context, clientID string) (*models.Client, error) {
...
func (_c *ClientRepositoryMock_GetByClientID_Call) Return(_a0 *models.Client, _a1 error) *ClientRepositoryMock_GetByClientID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ClientRepositoryMock_GetByClientID_Call) RunAndReturn(run func(context.Context, string) (*models.Client, error)) *ClientRepositoryMock_GetByClientID_Call {
	_c.Call.Return(run)
	return _c
}
