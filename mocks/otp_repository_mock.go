...
func (_m *OTPRepositoryMock) Create(ctx context.Context, otp *models.OTP) error {
...
func (_c *OTPRepositoryMock_Create_Call) Run(run func(ctx context.Context, otp *models.OTP)) *OTPRepositoryMock_Create_Call {
...
func (_c *OTPRepositoryMock_Create_Call) RunAndReturn(run func(context.Context, *models.OTP) error) *OTPRepositoryMock_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *OTPRepositoryMock) FindByID(ctx context.Context, id string) (*models.OTP, error) {
	ret := _m.Called(ctx, id)
...
func (_c *OTPRepositoryMock_FindByID_Call) Return(_a0 *models.OTP, _a1 error) *OTPRepositoryMock_FindByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *OTPRepositoryMock_FindByID_Call) RunAndReturn(run func(context.Context, string) (*models.OTP, error)) *OTPRepositoryMock_FindByID_Call {
	_c.Call.Return(run)
	return _c
}
